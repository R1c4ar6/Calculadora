...
public class ventana_calcu extends javax.swing.JFrame {
    ...
    public void operaciones(){
        switch (this.calculo) {
            case '+':
                String limpio=jTextField1.getText().replace("+", "");
                res=num+Double.parseDouble(limpio);
    ...
    private void initComponents() {
        ...
        jFrame1.getAccessibleContext().setAccessibleDescription("Realizacion de operaciones");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int tamaño=jTextField1.getText().length();
        int num=tamaño-1;
        String guardado;
        if (tamaño>0) {
            StringBuilder atras= new StringBuilder(jTextField1.getText());
            atras.deleteCharAt(num);
            guardado=atras.toString();
            jTextField1.setText(guardado);
        }
